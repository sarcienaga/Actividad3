...
contexto.lineWidth = 1; contexto.strokeStyle =colorText;
contexto.fillStyle =colorText;contexto.beginPath();contexto.strokeRect(10, 10,canvas.width-20,canvas.height-20);
contexto.font="bold 10px Verdana"; contexto.textAlign = "left"; contexto.fillText("Ejecutar",10.7,38); contexto.stroke();}
...
function cssColors(){
$("body").css("background-color",colorBack);$("#ardoraMain").css("color",colorText);$("#ardoraMain").css("font-family",fEnun);$("#ardoraTag").css("font-family",fActi);
